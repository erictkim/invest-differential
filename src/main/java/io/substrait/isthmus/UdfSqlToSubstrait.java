 ...
 *
 * This file resides in the io.substrait.isthmus package in order to extend
 * the package-private SqlConverterBase class from Apache Substrait Java
 * (Isthmus), which is also licensed under the Apache License, Version 2.0.
 * It is not part of, distributed by, or endorsed by the Substrait project.
 */
